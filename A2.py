...
class RpsGame():
    ...
    def player(self):
        if self.rock_btn.clicked(30):
            self.p_option = "rock"
            self.screen.blit(self.choose_rock, (128,200))
    ...
    def pc_score_cache(self):
        ...
        if pc == "rock" and pl == "paper" or pc == "paper" and pl == "scissors" or pc == "scissors" and pl == "rock":
            self.pl_score += 1
        elif pc == pl:
            pass
        else:
    ...
    def game_loop(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if self.rock_btn.clicked(30) or self.paper_btn.clicked(340) or self.scissorrs_btn.clicked(640):
